...
<form method="POST" action="proses_produk.php">
  ...
  <div class="form-group row">
    <label for="jenis" class="col-4 col-form-label">Jenis Kategori</label>
    <div class="col-8">
      <?php
  ...
  <!-- <div class="form-group row">
    <label for="gambar" class="col-4 col-form-label">Foto Produk</label>
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="gambar" name="gambar" value="" type="file" class="form-control">
      </div>
    </div>
  </div> -->
  <div class="form-group row">
